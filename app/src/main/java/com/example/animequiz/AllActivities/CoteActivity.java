...
import com.example.animequiz.QuestionAnswer.Coteqns;
import com.example.animequiz.QuestionAnswer.Narutoqns;
import com.example.animequiz.R;

public class CoteActivity extends AppCompatActivity implements View.OnClickListener{
    private TextView totalQuestionTextView, questions;
    private Button optionA, optionB, optionC, optionD, submitButton;
    private int score = 0;
    private final int questionLength = Coteqns.questions.length;
    private int currentQuestionIndex = 0;
    private String[] selectedAnswer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cote);
    ...
    private void loadNewQuestion() {
        ...
        questions.setText(Coteqns.questions[currentQuestionIndex]);
        optionA.setText(Coteqns.choices[currentQuestionIndex][0]);
        optionB.setText(Coteqns.choices[currentQuestionIndex][1]);
        optionC.setText(Coteqns.choices[currentQuestionIndex][2]);
        optionD.setText(Coteqns.choices[currentQuestionIndex][3]);
    }
    private void finishQuiz() {
        ...
        for (int i = 0; i < questionLength; i++) {
            ...
            resultMessage.append(", Correct Answer: ").append(Coteqns.correctAnswers[i]);
        }
    ...
    private void restartQuiz() {
        ...
        // Start QuizActivity
        Intent cote = new Intent(CoteActivity.this, QuizActivity.class);
        startActivity(cote);
